...
{
    #[Route('/sentence', name: 'app_sentence_index', methods: ['GET'])]
    ...
    #[Route('admin/sentence/new', name: 'app_sentence_new', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/sentence{id}/edit', name: 'app_sentence_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/sentence/{id}', name: 'app_sentence_delete', methods: ['POST'])]
